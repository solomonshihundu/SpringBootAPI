...
import com.comulynx.wallet.rest.api.repository.JoinedInfoRepository;
...
public class AccountController {
	...
	@Autowired
	JoinedInfoRepository joinedInfoRepository;
	...
	public ResponseEntity<?> getAccountByCustomerIdOrAccountNo(
		...
		JoinedInfo account = joinedInfoRepository
				.accountByCustomerId(customerIdOrAccountNo)
	...
	public ResponseEntity<?> getAccountBalanceByCustomerIdAndAccountNo(@RequestBody String request)
		...
		try {
			...
			Account account =  accountRepository.findAccountByCustomerId(customerId)
					.orElseThrow(()->new ResourceNotFoundException("Account not found, with customerId "+customerId));
